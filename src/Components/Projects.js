      ...
      <div className="all-bg project-flex-container">
        ...
        <div className="project-container">
          <div className="project">
            ...
            <a className="github-link" target="_blank" rel="noopener noreferrer" href= "https://github.com/Elliediazz/JediBook-Client" >Github Link</a>
          ...
          <div className="project">
            ...
            <a className="github-link" target="_blank" rel="noopener noreferrer" href= "https://github.com/Elliediazz/CDEV-Quizzes-Client" >Github Link</a>
            <h3 className="project-discription">
